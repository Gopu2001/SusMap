...
//data:image/png;base64,
        ...
        frame.innerHTML = `
        <ion-card no-padding button=true (click)="goToPage(` + building['BUILDING_ID'] + `);">
          <ion-card-header>
        ...
        this.buildings[i]['htmlInfoWindow'] = htmlInfoWindow;
        ...
        polygon.on(GoogleMapsEvent.POLYGON_CLICK).subscribe((data) => {
          ...
          htmlInfoWindow.open(this.buildings[i]['center']);
